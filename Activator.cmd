...
set "blank="
set "mas=ht%blank%tps%blank%://help.ispbills.com/"
...
choice /C:10 /N
if !errorlevel!==2 rem
if !errorlevel!==1 (start ht%-%tps://github.com/lupael/Microsoft-Acti%-%vation-Scripts & start %mas% & exit /b)
)
)
cls
...
echo:             [0] Exit
echo:             
call :_color2 %_White% "          " %_Green% 			"Script Developed by Lupael"
echo:       ______________________________________________________________
echo:
